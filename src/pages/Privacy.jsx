        ...
        <div className="min-h-screen p-4 sm:p-8 max-w-3xl mx-auto w-full">
            ...
            <div className="space-y-4">
                ...
                <Section icon={Database} title="1. Information We Collect" delay={0.1}>
                    ...
                    <p><strong className="text-white">Webcam Presence Verification (Focus Cam):</strong> When using the Focus Cam feature, FocusFlow accesses your camera. All face detection, tracking, and presence verification are performed entirely locally and client-side on your device inside your browser. We do **not** record, stream, store, or transmit your webcam video feed. To support the live spectator grid, only a highly compressed, low-resolution preview snapshot (thumbnail) is sent to Firestore and updated every 10 seconds. This preview is automatically deleted when your focus session ends.</p>
